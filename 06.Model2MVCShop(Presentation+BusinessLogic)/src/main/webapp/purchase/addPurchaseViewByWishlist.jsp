...
function fncAddPurchaseByWishlist() {
	document.detailForm.action='/purchase/addPurchaseByWishlist';
	...
	<tr class="ct_list_pop">
		...
		<td align="left">
			<select 	name="purchaseQt"		class="ct_input_g" 
				...
				<c:forEach var="i" begin="1" end="${wish.remain}" >			
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
						<a href="javascript:fncAddPurchaseByWishlist();">구매</a>
					</td>
